...
# `look4files.sh` creates a reusable function that can be called in terminal 

This will look for a specific <string> in files with extensions <(PDF, docx, doc, md, R, qmd)> in <given path>
