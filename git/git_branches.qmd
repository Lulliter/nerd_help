...
GOAL = `git merge master`:  **MY GOAL HERE is to UPDATE `wkg_branch` with all the new stuff I have on `master`** (this eon't affect master)
...
d. **Use a merge tool**  like in VS CODE
...
## 4. (optional) merge the branch into master 
